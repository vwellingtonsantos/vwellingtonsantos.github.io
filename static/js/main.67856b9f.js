...
(() => {
	...
	(t.m = e),
		...
		(() => {
			...
			var n = (n, r) => {
				...
				r = (self.webpackChunkwellington_santos =
					self.webpackChunkwellington_santos || []);
	...
	const s = function () {
			return (
				(0, r.useEffect)(() => {
					document.title = "Wellington Santos";
				}, []),
				(0, i.jsxs)("div", {
					id: "parent",
					children: [
						...
						(0, i.jsx)("footer", {
							id: "cnpj",
							children:
								"WELLINGTON AZEVEDO DOS SANTOS VEREADOR CNPJ 56.466.560/0001-90",
						}),
					],
				})
			);
